...
export function SessionProvider(props: React.PropsWithChildren) {
  ...
  const parsedSession = JSON.parse(session as string) as any;
  ...
  const onChange = (key: keyof ISigninContextState, value: string | number | boolean | TSigninLoadingState | any) => setRequestState((prev) => ({ ...prev, [key]: value }));
